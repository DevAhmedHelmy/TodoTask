...
<!-- Mirrored from uselooper.com/page-project-board.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 31 Oct 2019 07:48:50 GMT -->
<head>
    <!-- Required meta tags -->
    <meta charset="utf-8">
    ...
    <link rel="stylesheet" href="{{asset('vendor/open-iconic/css/open-iconic-bootstrap.min.css')}}">
    <link rel="stylesheet" href="{{asset('vendor/fontawesome/css/all.css')}}">
    <link rel="stylesheet" href="{{asset('vendor/tributejs/tribute.css')}}">
    ...
    <!-- BEGIN THEME STYLES -->
    <link rel="stylesheet" href="{{asset('stylesheets/theme.min.css')}}">
    {{-- <link rel="stylesheet" href="{{asset('stylesheets/theme-dark.min.css')}}"> --}}
            ...
            <div class="page-inner page-inner-fill">
              ...
              <header class="page-navs shadow-sm pr-3">
                ...
                <a href="page-project.html" class="btn-account">
                  <div class="has-badge">
                    <span class="tile bg-pink text-white">SP</span> <span class="user-avatar user-avatar-xs"><img src="public/images/avatars/team4.jpg" alt=""></span>
                  </div>
                  ...
                  <div class="dropdown d-inline-block">
                    ...
                    <div class="dropdown-menu dropdown-menu-right dropdown-menu-rich stop-propagation">
                      ...
                      <div class="form-group px-3 py-2 m-0">
                        <input type="text" class="form-control" placeholder="e.g. @bent10" data-toggle="tribute" data-remote="public/data/tribute.json" data-menu-container="#people-list" data-item-template="true" data-autofocus="true"> <small class="form-text text-muted">Search people by username or email address to invite them.</small>
                      </div>
                            ...
                            <div class="list-group-item" data-toggle="modal" data-target="#modalViewTask">
                              ...
                              <div class="list-group-item-body">
                                ...
                                <figure class="user-avatar user-avatar-sm" data-toggle="tooltip" title="Johnny Day">
                                  <img src="public/images/avatars/uifaces2.jpg" alt="Johnny Day">
                                </figure>
                                <figure class="user-avatar user-avatar-sm" data-toggle="tooltip" title="Sarah Bishop">
                                  <img src="public/images/avatars/uifaces3.jpg" alt="Sarah Bishop">
                                </figure><!-- /members -->
                            ...
                            <div class="list-group-item" data-toggle="modal" data-target="#modalViewTask">
                              ...
                              <div class="list-group-item-body">
                                ...
                                <figure class="user-avatar user-avatar-sm" data-toggle="tooltip" title="Craig Hansen">
                                  <img src="public/images/avatars/uifaces5.jpg" alt="Craig Hansen">
                                </figure>
                                <figure class="user-avatar user-avatar-sm" data-toggle="tooltip" title="Jane Barnes">
                                  <img src="public/images/avatars/uifaces9.jpg" alt="Jane Barnes">
                                </figure><!-- /members -->
                              </div><!-- /.list-group-item-body -->
                            </div><!-- /.list-group-item -->
                            <!-- .list-group-item -->
                        ...
                        <div class="media">
                          ...
                          <div class="media-body">
                            <div class="avatar-group mb-2">
                              <a href="#" class="user-avatar user-avatar-sm"><img src="public/images/avatars/uifaces4.jpg" alt=""></a> <a href="#" class="user-avatar user-avatar-sm"><img src="public/images/avatars/uifaces5.jpg" alt=""></a> <a href="#" class="user-avatar user-avatar-sm"><img src="public/images/avatars/uifaces6.jpg" alt=""></a> <a href="#" class="user-avatar user-avatar-sm"><img src="public/images/avatars/uifaces7.jpg" alt=""></a>
                            </div>
                            <p class="mb-0">
                        ...
                        <div class="form-group">
                          ...
                          <div class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-md overflow-y-auto stop-propagation" data-flip="false" id="dntmAssignees" aria-labelledby="dropdownAssignee1" style="max-height: 30rem;">
                              ...
                              <div class="dropdown-divider"></div>
                              <h6 class="dropdown-header"> Assignee(s) </h6><label class="custom-control custom-checkbox filterable" data-sort="Beni Arisandi"><input type="checkbox" class="custom-control-input task-assignees" name="taskAssignees[]" value="4" data-label="Beni Arisandi" checked> <span class="custom-control-label custom-control-label-media"><span class="media"><span class="mr-2"><span class="user-avatar"><img src="public/images/avatars/uifaces1.jpg" alt=""></span></span> <span class="media-body">Beni Arisandi<br>
                                      <span class="text-muted">@benz</span></span></span></span></label> <label class="custom-control custom-checkbox filterable" data-sort="Melissa Day"><input type="checkbox" class="custom-control-input task-assignees" name="taskAssignees[]" value="2" data-label="Melissa Day" checked> <span class="custom-control-label custom-control-label-media"><span class="media"><span class="mr-2"><span class="user-avatar"><img src="public/images/avatars/uifaces4.jpg" alt=""></span></span> <span class="media-body">Melissa Day<br>
                                      <span class="text-muted">@melday</span></span></span></span></label>
                              <div id="dntDivider" class="dropdown-divider"></div><label class="custom-control custom-checkbox filterable" data-sort="Adam Medina"><input type="checkbox" class="custom-control-input task-assignees" name="taskAssignees[]" value="3" data-label="Adam Medina"> <span class="custom-control-label custom-control-label-media"><span class="media"><span class="mr-2"><span class="user-avatar"><img src="public/images/avatars/uifaces15.jpg" alt=""></span></span> <span class="media-body">Adam Medina<br>
                                      <span class="text-muted">@amed</span></span></span></span></label> <label class="custom-control custom-checkbox filterable" data-sort="Diana Miller"><input type="checkbox" class="custom-control-input task-assignees" name="taskAssignees[]" value="1" data-label="Diana Miller"> <span class="custom-control-label custom-control-label-media"><span class="media"><span class="mr-2"><span class="user-avatar"><img src="public/images/avatars/uifaces7.jpg" alt=""></span></span> <span class="media-body">Diana Miller<br>
                                      <span class="text-muted">@dmiller</span></span></span></span></label> <label class="custom-control custom-checkbox filterable" data-sort="Douglas Lucas"><input type="checkbox" class="custom-control-input task-assignees" name="taskAssignees[]" value="5" data-label="Douglas Lucas"> <span class="custom-control-label custom-control-label-media"><span class="media"><span class="mr-2"><span class="user-avatar"><img src="public/images/avatars/uifaces5.jpg" alt=""></span></span> <span class="media-body">Douglas Lucas<br>
            ...
            <div class="modal-dialog modal-lg modal-drawer-right" role="document">
              ...
              <div class="modal-content">
                ...
                <div class="modal-body p-3 p-lg-4">
                  ...
                  <hr>
                  <p class="text-muted"> Opened one week ago by <a href="#" class="link-text" data-toggle="tooltip" title="@jgrif"><span class="user-avatar user-avatar-xs"><img src="public/images/avatars/uifaces6.jpg" alt=""></span> Jacob Griffin</a>
                  </p>
                  <hr>
                    ...
                    <div class="col-6 mb-3">
                      ...
                      <div class="assignee">
                        ...
                        <div class="avatar-group">
                          <a href="#" class="user-avatar" data-toggle="tooltip" title="You"><img src="public/images/avatars/uifaces2.jpg" alt="You"></a> <a href="#" class="user-avatar" data-toggle="tooltip" title="Mellisa Day"><img src="public/images/avatars/uifaces4.jpg" alt="Mellisa Day"></a>
                          <div class="dropdown d-inline-block">
                            ...
                            <div class="dropdown-menu dropdown-menu-md overflow-auto stop-propagation" aria-labelledby="dropdownAssignee2" style="max-height: 30rem;">
                              ...
                              <div class="dropdown-divider"></div>
                              <h6 class="dropdown-header"> Assignee(s) </h6><label class="custom-control custom-checkbox filterable" data-sort="Beni Arisandi"><input type="checkbox" class="custom-control-input task-assignees" name="taskAssignees[]" value="4" data-label="Beni Arisandi" checked> <span class="custom-control-label custom-control-label-media"><span class="media"><span class="mr-2"><span class="user-avatar"><img src="public/images/avatars/uifaces2.jpg" alt=""></span></span> <span class="media-body">Beni Arisandi<br>
                                      <span class="text-muted">@benz</span></span></span></span></label> <label class="custom-control custom-checkbox filterable" data-sort="Melissa Day"><input type="checkbox" class="custom-control-input task-assignees" name="taskAssignees[]" value="2" data-label="Melissa Day" checked> <span class="custom-control-label custom-control-label-media"><span class="media"><span class="mr-2"><span class="user-avatar"><img src="public/images/avatars/uifaces4.jpg" alt=""></span></span> <span class="media-body">Melissa Day<br>
                                      <span class="text-muted">@melday</span></span></span></span></label>
                              <div id="dntmDivider" class="dropdown-divider"></div><label class="custom-control custom-checkbox filterable" data-sort="Adam Medina"><input type="checkbox" class="custom-control-input task-assignees" name="taskAssignees[]" value="3" data-label="Adam Medina"> <span class="custom-control-label custom-control-label-media"><span class="media"><span class="mr-2"><span class="user-avatar"><img src="public/images/avatars/uifaces15.jpg" alt=""></span></span> <span class="media-body">Adam Medina<br>
                                      <span class="text-muted">@amed</span></span></span></span></label> <label class="custom-control custom-checkbox filterable" data-sort="Diana Miller"><input type="checkbox" class="custom-control-input task-assignees" name="taskAssignees[]" value="1" data-label="Diana Miller"> <span class="custom-control-label custom-control-label-media"><span class="media"><span class="mr-2"><span class="user-avatar"><img src="public/images/avatars/uifaces9.jpg" alt=""></span></span> <span class="media-body">Diana Miller<br>
                                      <span class="text-muted">@dmiller</span></span></span></span></label> <label class="custom-control custom-checkbox filterable" data-sort="Douglas Lucas"><input type="checkbox" class="custom-control-input task-assignees" name="taskAssignees[]" value="5" data-label="Douglas Lucas"> <span class="custom-control-label custom-control-label-media"><span class="media"><span class="mr-2"><span class="user-avatar"><img src="public/images/avatars/uifaces5.jpg" alt=""></span></span> <span class="media-body">Douglas Lucas<br>
                                      <span class="text-muted">@lucaldoug</span></span></span></span></label>
                            </div><!-- /.dropdown-menu -->
                          </div>
...
<script src="{{asset('vendor/tributejs/tribute.min.js')}}"></script>
...
<script src="{{asset('vendor/flatpickr/flatpickr.min.js')}}"></script>
    ...
    <!-- BEGIN THEME JS -->
  <!-- END THEME JS -->
    <script src="{{asset('javascript/theme.min.js')}}"></script>
<script src="{{asset('javascript/pages/board-demo.js')}}"></script>
...
<!-- Mirrored from uselooper.com/page-project-board.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 31 Oct 2019 07:49:02 GMT -->
</html>